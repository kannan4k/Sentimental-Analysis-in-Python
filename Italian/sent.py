...
def getNegationCount(wordsArticle, freqDist, negationList):
    ...
    for word in negationList:
        #print word
        if freqDist.has_key(word):
            positiveList = returnList('itaPositive.txt')
            negativeList = returnList('itaNegative.txt')  
...
def getArticleCount(split_paper):
    ...
    negationList = returnList('itaNEGATION.txt')
    positiveList = returnList('itaPositive.txt') #Callinn returnList fnction to create list of words
    negativeList = returnList('itaNegative.txt')
    modalWeakList = returnList('itaModalWeek.txt')
    modalStringList = returnList('itaModalStrong.txt')
    litigiousList = returnList('itaLitigious.txt')
    uncertaintyList =  returnList('itaUncertainty.txt')
